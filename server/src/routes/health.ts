...
// Create factory function to avoid circular dependency
export const createHealthRoutes = (dbService: DatabaseService, wsService: WebSocketService) => {
  const router = Router()
...
// Default export for backward compatibility (simple health check without services)
const router = Router()
